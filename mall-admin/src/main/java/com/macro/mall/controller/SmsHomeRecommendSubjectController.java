...
public class SmsHomeRecommendSubjectController {
    ...
    @ResponseBody
    public CommonResult create(@RequestBody List<SmsHomeRecommendSubject> homeRecommendSubjects) {
        int count = homeRecommendSubjectService.create(homeRecommendSubjects);
        if (count > 0) {
    ...
    public CommonResult<CommonPage<SmsHomeRecommendSubject>> list(@RequestParam(value = "subjectName", required = false) String subjectName,
        ...
        List<SmsHomeRecommendSubject> homeRecommendSubjectList = homeRecommendSubjectService.list(subjectName, recommendStatus, pageSize, pageNum);
